...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { email: @developer.email, first_name: @developer.first_name, last_name: @developer.last_name }
    end
  ...
  test "should update developer" do
    put :update, id: @developer, developer: { email: @developer.email, first_name: @developer.first_name, last_name: @developer.last_name }
    assert_redirected_to developer_path(assigns(:developer))
  end
